...
fetchChannelBlock() {
    ...
    peer channel fetch 0 ./channel-artifacts/$CHANNEL_NAME.block -o 34.132.201.19:7050 \
...
updateAnchorPeers() {
    setGlobalsForPeer0Org2
    # Replace localhost with your orderer's vm IP address
    peer channel update -o 34.132.201.19:7050 --ordererTLSHostnameOverride orderer.example.com \
