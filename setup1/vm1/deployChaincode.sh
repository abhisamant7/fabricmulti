...
approveForMyOrg1() {
    ...
    peer lifecycle chaincode approveformyorg -o 34.132.201.19:7050 \
...
commitChaincodeDefination() {
    setGlobalsForPeer0Org1
    peer lifecycle chaincode commit -o 34.132.201.19:7050 --ordererTLSHostnameOverride orderer.example.com \
...
chaincodeInvokeInit() {
    setGlobalsForPeer0Org1
    peer chaincode invoke -o 34.132.201.19:7050 \
